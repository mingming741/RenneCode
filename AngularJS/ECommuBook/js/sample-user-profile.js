  ...
  json = {
    Operations: [
      ...
      },
      {
        OperationType: "Menu",
        DisplayMultipleLanguage: [
          {"Language":"de","Text":"Main Page"},
          {"Language":"ru","Text":"Главная страница"},
          {"Language":"pt","Text":"Principal página"},
          {"Language":"ko","Text":"메인 페이지"},
          {"Language":"yue","Text":"主頁"},
          {"Language":"en","Text":"Main Page"},
          {"Language":"it","Text":"Principale pagina"},
          {"Language":"fr","Text":"Main Page"},
          {"Language":"es","Text":"Principal página"},
          {"Language":"zh-CHT","Text":"主頁"},
          {"Language":"ar","Text":"الرئيسية الصفحة"},
          {"Language":"zh-CHS","Text":"主页"},
          {"Language":"ja","Text":"メイン ページ"}],
        SubPage:[
          {
      ...
      {
        OperationType: "ShareContent",
        DisplayMultipleLanguage: [
          {"Language":"de","Text":"Inhalte teilen"},
          {"Language":"ru","Text":"Доля содержания"},
          {"Language":"pt","Text":"Compartilhar conteúdo"},
          {"Language":"ko","Text":"공유 콘텐츠"},
          {"Language":"yue","Text":"共享內容"},
          {"Language":"en","Text":"Share Content"},
          {"Language":"it","Text":"Condividere i contenuti"},
          {"Language":"fr","Text":"Partager le contenu"},
          {"Language":"es","Text":"Compartir contenido"},
          {"Language":"zh-CHT","Text":"共用內容"},
          {"Language":"ar","Text":"مشاركة المحتوى"},
          {"Language":"zh-CHS","Text":"共享内容"},
          {"Language":"ja","Text":"コンテンツを共有します。"}],
        SubPage: [
          {
      ...
      },
      {
        ...
        SubPage: [
          {
            OperationType: "SearchGuide1",
            DisplayMultipleLanguage: [
              { Language: "de", Text: "Drücken Sie Start, um ein Wort aufzuzeichnen" },
              { Language: "ru", Text: "Чтобы записать слова нажмите кнопку Старт" },
              { Language: "pt", Text: "Pressione Start para gravar uma palavra" },
              { Language: "ko", Text: "단어를 기록 하는 시작" },
              { Language: "yue", Text: "按 \"開始\" 記錄單詞" },
              { Language: "en", Text: "Press Start to Record a Word" },
              { Language: "it", Text: "Premere Start per registrare una parola" },
              { Language: "fr", Text: "Appuyez sur Start pour enregistrer un mot" },
              { Language: "es", Text: "Pulse Iniciar para grabar una palabra" },
              { Language: "zh-CHT", Text: "按 \"開始\" 記錄單詞" },
              { Language: "ar", Text: "اضغط على بدء لتسجيل كلمة" },
              { Language: "zh-CHS", Text: "按 \"开始\" 记录单词" },
              { Language: "ja", Text: "単語の記録を開始を押す" }]
          },
          {
            OperationType: "SearchGuide2",
            DisplayMultipleLanguage: [
              { Language: "de", Text: "Presse-Upload für die Online-Suche" },
              { Language: "ru", Text: "Нажмите кнопку Загрузить для онлайн Поиск" },
              { Language: "pt", Text: "Pressione Upload para pesquisa on-line" },
              { Language: "ko", Text: "온라인 검색에 대 한 업로드를 누르면" },
              { Language: "yue", Text: "按上載進行聯機搜索" },
              { Language: "en", Text: "Press Upload for online search" },
              { Language: "it", Text: "Premere Upload per ricerca online" },
              { Language: "fr", Text: "Appuyez sur Upload pour la recherche en ligne" },
              { Language: "es", Text: "Presiona Upload para búsqueda en línea" },
              { Language: "zh-CHT", Text: "按上載進行連線搜索" },
              { Language: "ar", Text: "اضغط تحميل للبحث على الإنترنت" },
              { Language: "zh-CHS", Text: "按上载进行联机搜索" },
              { Language: "ja", Text: "オンライン検索のアップロードを押す" }]
          },
          {
            OperationType: "SearchResult",
            DisplayMultipleLanguage: [
              { Language: "de", Text: "Suchergebnis" },
              { Language: "ru", Text: "Результат поиска" },
              { Language: "pt", Text: "Resultado da pesquisa" },
              { Language: "ko", Text: "검색 결과" },
              { Language: "yue", Text: "搜索結果" },
              { Language: "en", Text: "Search Result" },
              { Language: "it", Text: "Risultato della ricerca" },
              { Language: "fr", Text: "Résultat de la recherche" },
              { Language: "es", Text: "Resultados de búsqueda" },
              { Language: "zh-CHT", Text: "搜尋結果" },
              { Language: "ar", Text: "نتيجة البحث" },
              { Language: "zh-CHS", Text: "搜索结果" },
              { Language: "ja", Text: "検索結果" }]
          }
        ]
      },
      {
      ...
      {
        OperationType: "AboutUs",
        DisplayMultipleLanguage: [
          {"Language":"de","Text":"Über uns"},
          {"Language":"ru","Text":"О нас"},
          {"Language":"pt","Text":"Quem somos"},
          {"Language":"ko","Text":"우리에 관해서"},
          {"Language":"yue","Text":"關於我哋"},
          {"Language":"en","Text":"About Us"},
          {"Language":"it","Text":"Chi Siamo"},
          {"Language":"fr","Text":"Qui sommes-nous"},
          {"Language":"es","Text":"Sobre nosotros"},
          {"Language":"zh-CHT","Text":"關於我們"},
          {"Language":"ar","Text":"من نحن"},
          {"Language":"zh-CHS","Text":"关于我们"},
          {"Language":"ja","Text":"我々について"}],
        SubPage: [
          {
            OperationType: "DeveloperInformation",
            DisplayMultipleLanguage: [
              {"Language":"de","Text":"Entwicklerinformationen"},
              {"Language":"ru","Text":"Информация для разработчиков"},
              {"Language":"pt","Text":"Informações do desenvolvedor"},
              {"Language":"ko","Text":"개발자 정보"},
              {"Language":"yue","Text":"開發人員信息"},
              {"Language":"en","Text":"Developer Information"},
              {"Language":"it","Text":"Informazioni per gli sviluppatori"},
              {"Language":"fr","Text":"Informations pour développeurs"},
              {"Language":"es","Text":"Información para los desarrolladores"},
              {"Language":"zh-CHT","Text":"開發人員資訊"},
              {"Language":"ar","Text":"معلومات خاصة بالمطورين"},
              {"Language":"zh-CHS","Text":"开发人员信息"},
              {"Language":"ja","Text":"開発者向けの情報"}]
          },
          {
            OperationType: "DeveloperOrganization",
            DisplayMultipleLanguage: [
              {"Language":"de","Text":"Entwickler-Organisation"},
              {"Language":"ru","Text":"Организация разработчика"},
              {"Language":"pt","Text":"Organização de desenvolvedor"},
              {"Language":"ko","Text":"개발자 조직"},
              {"Language":"yue","Text":"開發人員組織"},
              {"Language":"en","Text":"Developer Organization"},
              {"Language":"it","Text":"Organizzazione di sviluppatore"},
              {"Language":"fr","Text":"Organisation de développeur"},
              {"Language":"es","Text":"Organización de desarrollo"},
              {"Language":"zh-CHT","Text":"開發人員組織"},
              {"Language":"ar","Text":"منظمة المطور"},
              {"Language":"zh-CHS","Text":"开发人员组织"},
              {"Language":"ja","Text":"開発者の組織"}]
          },
          {
            OperationType: "UserFeedback",
            DisplayMultipleLanguage: [
              {"Language":"de","Text":"Benutzer-Feedback"},
              {"Language":"ru","Text":"Отзывы пользователей"},
              {"Language":"pt","Text":"Feedback do usuário"},
              {"Language":"ko","Text":"사용자 피드백"},
              {"Language":"yue","Text":"用戶反饋"},
              {"Language":"en","Text":"User Feedback"},
              {"Language":"it","Text":"Feedback degli utenti"},
              {"Language":"fr","Text":"Commentaires des utilisateurs"},
              {"Language":"es","Text":"Comentarios de los usuarios"},
              {"Language":"zh-CHT","Text":"使用者回饋"},
              {"Language":"ar","Text":"تعليقات المستخدم"},
              {"Language":"zh-CHS","Text":"用户反馈"},
              {"Language":"ja","Text":"ユーザーからのフィードバック"}]
          },
          {
            OperationType: "Feedback",
            DisplayMultipleLanguage: [
              {"Language":"de","Text":"Feedback"},
              {"Language":"ru","Text":"Обратная связь"},
              {"Language":"pt","Text":"Gabarito"},
              {"Language":"ko","Text":"피드백"},
              {"Language":"yue","Text":"反饋"},
              {"Language":"en","Text":"Feedback"},
              {"Language":"it","Text":"Feedback"},
              {"Language":"fr","Text":"Vos commentaires"},
              {"Language":"es","Text":"Comentarios"},
              {"Language":"zh-CHT","Text":"回饋"},
              {"Language":"ar","Text":"التغذية المرتدة"},
              {"Language":"zh-CHS","Text":"反馈"},
              {"Language":"ja","Text":"フィードバック"}]
          },
          {
            OperationType: "FeedbackNotice",
            DisplayMultipleLanguage: [
              {"Language":"de","Text":"Danke, dass du diese app und wir begrüßen alle Nutzer-feedback"},
              {"Language":"ru","Text":"Спасибо за использование этого приложения, и мы приветствуем любые отзывы пользователей"},
              {"Language":"pt","Text":"Obrigado por usar este app e congratulamo-nos com qualquer feedback do usuário"},
              {"Language":"ko","Text":"이 애플 리 케이이 션을 사용 하 여 주셔서 감사 합니다. 그리고 우리는 사용자의 피드백을 환영 합니다."},
              {"Language":"yue","Text":"感謝使用這個應用程序, 我哋歡迎任何用戶反饋"},
              {"Language":"en","Text":"Thanks for using this app and we welcome any user feedback"},
              {"Language":"it","Text":"Grazie per l'utilizzo di questa app e diamo il benvenuto a qualsiasi feedback utente"},
              {"Language":"fr","Text":"Merci d’utiliser ce soft et nous accueillons favorablement tout commentaire de l’utilisateur"},
              {"Language":"es","Text":"Gracias por usar esta aplicación y damos la bienvenida a cualquier comentario de usuarios"},
              {"Language":"zh-CHT","Text":"感謝使用這個應用程式, 我們歡迎任何使用者回饋"},
              {"Language":"ar","Text":"شكرا لاستخدام هذا التطبيق، ونحن نرحب بأي تعليقات المستخدم"},
              {"Language":"zh-CHS","Text":"感谢使用这个应用程序, 我们欢迎任何用户反馈"},
              {"Language":"ja","Text":"このアプリを使用するためのおかげで、我々 は、ユーザーからのフィードバックを歓迎"}]
          },
          {
            OperationType: "FeedbackType",
            DisplayMultipleLanguage: [
              {"Language":"de","Text":"Feedback-Typ"},
              {"Language":"ru","Text":"Тип обратной связи"},
              {"Language":"pt","Text":"Tipo de gabarito"},
              {"Language":"ko","Text":"피드백 유형"},
              {"Language":"yue","Text":"反饋類型"},
              {"Language":"en","Text":"Feedback Type"},
              {"Language":"it","Text":"Tipo di feedback"},
              {"Language":"fr","Text":"Type de commentaire"},
              {"Language":"es","Text":"Tipo de retroalimentación"},
              {"Language":"zh-CHT","Text":"回饋類型"},
              {"Language":"ar","Text":"نوع تغذية مرتدة"},
              {"Language":"zh-CHS","Text":"反馈类型"},
              {"Language":"ja","Text":"フィードバックの種類"}]
          },
          {
            OperationType: "FeedbackContent",
            DisplayMultipleLanguage: [
              {"Language":"de","Text":"Feedback-Inhalt"},
              {"Language":"ru","Text":"Содержание обратной связи"},
              {"Language":"pt","Text":"Conteúdo do gabarito"},
              {"Language":"ko","Text":"피드백 내용"},
              {"Language":"yue","Text":"反饋內容"},
              {"Language":"en","Text":"Feedback Content"},
              {"Language":"it","Text":"Contenuto di feedback"},
              {"Language":"fr","Text":"Contenu de la rétroaction"},
              {"Language":"es","Text":"Contenido de la retroalimentación"},
              {"Language":"zh-CHT","Text":"回饋內容"},
              {"Language":"ar","Text":"ملاحظات المحتوى"},
              {"Language":"zh-CHS","Text":"反馈内容"},
              {"Language":"ja","Text":"フィードバック内容"}]
          },
          {
            OperationType: "FeedbackSuccess",
            DisplayMultipleLanguage: [
              {"Language":"de","Text":"Laden Sie Feedback Erfolg, vielen Dank für das feedback"},
              {"Language":"ru","Text":"Добавлено обратной связи успеха, спасибо за отзыв"},
              {"Language":"pt","Text":"Upload de sucesso de gabarito, obrigado pelo feedback"},
              {"Language":"ko","Text":"업로드 성공 피드백, 의견을 주셔서 감사 합니다"},
              {"Language":"yue","Text":"貼反饋成功, 多謝你嘅反饋"},
              {"Language":"en","Text":"Upload feedback success, Thank you for the feedback"},
              {"Language":"it","Text":"Caricare il successo di feedback, grazie per il feedback"},
              {"Language":"fr","Text":"Télécharger le succès de vos commentaires, Merci pour les commentaires"},
              {"Language":"es","Text":"Subir éxito de comentarios, gracias por los comentarios"},
              {"Language":"zh-CHT","Text":"上傳回饋成功, 感謝您的回饋"},
              {"Language":"ar","Text":"تحميل النجاح التغذية المرتدة، وشكرا لكم على ردود الفعل"},
              {"Language":"zh-CHS","Text":"上传反馈成功, 感谢您的反馈"},
              {"Language":"ja","Text":"フィードバック成功、フィードバックをありがとうアップロードします。"}]
          },
          {
            OperationType: "GeneralProblem",
            DisplayMultipleLanguage: [
              {"Language":"de","Text":"Allgemeines Problem"},
              {"Language":"ru","Text":"Проблема общего"},
              {"Language":"pt","Text":"Problema geral"},
              {"Language":"ko","Text":"일반 문제"},
              {"Language":"yue","Text":"一般問題"},
              {"Language":"en","Text":"General Problem"},
              {"Language":"it","Text":"Problema generale"},
              {"Language":"fr","Text":"PROBLEME General"},
              {"Language":"es","Text":"Problema general"},
              {"Language":"zh-CHT","Text":"一般問題"},
              {"Language":"ar","Text":"المشكلة العامة"},
              {"Language":"zh-CHS","Text":"一般问题"},
              {"Language":"ja","Text":"一般的な問題"}]
          },
          {
            OperationType: "BugReport",
            DisplayMultipleLanguage: [
              {"Language":"de","Text":"Bug-Report"},
              {"Language":"ru","Text":"Отчет об ошибке"},
              {"Language":"pt","Text":"Relatório de bug"},
              {"Language":"ko","Text":"버그 리포트"},
              {"Language":"yue","Text":"bug 報告"},
              {"Language":"en","Text":"Bug Report"},
              {"Language":"it","Text":"Segnalazione di bug"},
              {"Language":"fr","Text":"Rapport de bug"},
              {"Language":"es","Text":"Informe de error"},
              {"Language":"zh-CHT","Text":"Bug 報告"},
              {"Language":"ar","Text":"تقرير الأخطاء"},
              {"Language":"zh-CHS","Text":"Bug 报告"},
              {"Language":"ja","Text":"バグ報告"}]
          },
          {
            OperationType: "Suggestion",
            DisplayMultipleLanguage: [
              {"Language":"de","Text":"Vorschlag"},
              {"Language":"ru","Text":"Предложение"},
              {"Language":"pt","Text":"Sugestão"},
              {"Language":"ko","Text":"제안"},
              {"Language":"yue","Text":"建議"},
              {"Language":"en","Text":"Suggestion"},
              {"Language":"it","Text":"Suggerimento"},
              {"Language":"fr","Text":"Suggestion"},
              {"Language":"es","Text":"Sugerencia"},
              {"Language":"zh-CHT","Text":"建議"},
              {"Language":"ar","Text":"اقتراح"},
              {"Language":"zh-CHS","Text":"建议"},
              {"Language":"ja","Text":"提案"}]
          },
          {
            OperationType: "QuestionAboutApp",
            DisplayMultipleLanguage: [
              {"Language":"de","Text":"Frage zur Verwendung von App"},
              {"Language":"ru","Text":"Вопрос о том, как использовать приложение"},
              {"Language":"pt","Text":"Pergunta sobre como usar o App"},
              {"Language":"ko","Text":"응용 프로그램을 사용 하는 방법에 대 한 질문"},
              {"Language":"yue","Text":"關於如何使用應用程序的問題"},
              {"Language":"en","Text":"Question About How To Use App"},
              {"Language":"it","Text":"Domanda su come utilizzare App"},
              {"Language":"fr","Text":"Question sur la façon d’utiliser App"},
              {"Language":"es","Text":"Pregunta acerca de cómo utilizar la aplicación"},
              {"Language":"zh-CHT","Text":"關於如何使用應用程式的問題"},
              {"Language":"ar","Text":"سؤال حول كيفية استخدام التطبيق"},
              {"Language":"zh-CHS","Text":"关于如何使用应用程序的问题"},
              {"Language":"ja","Text":"アプリを使用する方法についての質問"}]
          },
          {
            OperationType: "FeedbackTypeWarning",
            DisplayMultipleLanguage: [
              {"Language":"de","Text":"Bitte geben Sie Benutzer-Feedback-Typ"},
              {"Language":"ru","Text":"Введите тип обратной связи пользователя"},
              {"Language":"pt","Text":"Por favor, insira o tipo de gabarito de usuário"},
              {"Language":"ko","Text":"사용자 피드백 타입을 입력 해 주세요"},
              {"Language":"yue","Text":"請輸入用戶反饋類型"},
              {"Language":"en","Text":"Please input user feedback type"},
              {"Language":"it","Text":"Si prega di inserire il tipo di feedback utente"},
              {"Language":"fr","Text":"Entrez le type de rétroaction d’utilisateur"},
              {"Language":"es","Text":"Por favor ingrese el tipo de retroalimentación del usuario"},
              {"Language":"zh-CHT","Text":"請輸入使用者回饋類型"},
              {"Language":"ar","Text":"الرجاء إدخال نوع التغذية المرتدة المستخدم"},
              {"Language":"zh-CHS","Text":"请输入用户反馈类型"},
              {"Language":"ja","Text":"ユーザー フィードバックの種類を入力してください。"}]
          },
          {
            OperationType: "FeedbackTextWarning",
            DisplayMultipleLanguage: [
              {"Language":"de","Text":"Bitte geben Sie Benutzer-Feedback-content"},
              {"Language":"ru","Text":"Пожалуйста, введите пользователя содержание обратной связи"},
              {"Language":"pt","Text":"Por favor, insira o conteúdo do gabarito de usuário"},
              {"Language":"ko","Text":"사용자 피드백 내용 입력 해 주세요"},
              {"Language":"yue","Text":"請輸入用戶反饋內容"},
              {"Language":"en","Text":"Please input user feedback content"},
              {"Language":"it","Text":"Si prega di inserire contenuti di feedback dell'utente"},
              {"Language":"fr","Text":"Veuillez entrer le contenu de vos commentaires par l’utilisateur"},
              {"Language":"es","Text":"Por favor ingrese el contenido del feedback del usuario"},
              {"Language":"zh-CHT","Text":"請輸入使用者回饋內容"},
              {"Language":"ar","Text":"الرجاء إدخال محتوى تعليقات المستخدم"},
              {"Language":"zh-CHS","Text":"请输入用户反馈内容"},
              {"Language":"ja","Text":"ユーザー フィードバックの内容を入力してください。"}]
          },
        ]
      },
      {
